...
public class OptionListActivity extends FragmentActivity
    ...
    public final static String CS_BANNER_URL = "http://redsox.tcs.auckland.ac.nz/CSS/CSService.svc/home_image";
	...
	private class LoadCSBanner extends AsyncTask<String, Void, Bitmap> {
